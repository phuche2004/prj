...
-- Add ImageURL column to MenuItems table
ALTER TABLE MenuItems
ADD ImageURL NVARCHAR(255);
GO

-- Update existing menu items with sample image URLs
UPDATE MenuItems SET ImageURL = 'images/menu/spring-rolls.jpg' WHERE ItemName = 'Spring Rolls';
UPDATE MenuItems SET ImageURL = 'images/menu/chicken-wings.jpg' WHERE ItemName = 'Chicken Wings';
UPDATE MenuItems SET ImageURL = 'images/menu/grilled-salmon.jpg' WHERE ItemName = 'Grilled Salmon';
UPDATE MenuItems SET ImageURL = 'images/menu/beef-steak.jpg' WHERE ItemName = 'Beef Steak';
UPDATE MenuItems SET ImageURL = 'images/menu/chocolate-cake.jpg' WHERE ItemName = 'Chocolate Cake';
UPDATE MenuItems SET ImageURL = 'images/menu/soft-drink.jpg' WHERE ItemName = 'Soft Drink';
UPDATE MenuItems SET ImageURL = 'images/menu/fresh-juice.jpg' WHERE ItemName = 'Fresh Juice';
GO