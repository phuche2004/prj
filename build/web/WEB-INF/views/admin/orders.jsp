...
<html>
    ...
    <body>
        <div class="container">
            ...
            <div class="nav-tabs">
                <a href="${pageContext.request.contextPath}/admin/orders" class="nav-tab active">Orders</a>
                <a href="${pageContext.request.contextPath}/admin/products" class="nav-tab">Products</a>
            </div>
